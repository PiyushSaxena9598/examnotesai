...
function FinalResult({ result }) {
  ...
  return (
    <div className="mt-6 p-3 space-y-10 bg-white">
      ...
      {quickRevision && (
        <section className="rounded-xl bg-linear-to-r from-green-100 to-green-50 border border-green-200">
...
function SectionHeader({ icon, title, color }) {
  ...
  return (
    <div
      className={`mb-4 px-4 py-2 rounded-lg bg-linear-to-r ${colors[color]} font-bold flex items-center gap-2`}
    >
      <span>{icon}</span>
      <span>{title}</span>
    </div>
