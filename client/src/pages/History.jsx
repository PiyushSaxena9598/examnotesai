            ...
            >
              ...
              <div className="mb-4 space-y-1">
                <button
                  ...
                  className="w-full px-3 py-2 rounded-lg text-sm text-gray-200 bg-white/10 hover:bg-white/20 text-start"
                >
                  ➕ New Notes
                </button>
                ...
                <ul className="space-y-3">
                  {topics.map((t, i) => (
                    <li
                      ...
                      key={i}
                      className={`rounded-xl cursor-pointer p-3 border transition-all ${activeNoteId === t._id ? "bg-indigo-500/30 border-indigo-400 shadow-[0_0_0_1px_rgba(99, 102, 241, 0.6)]" : "bg-white/5 border-white/10 hover:bg-white/10"}`}
                    >
